import inspect
import unittest
from solucion import frecuencia_posicion_por_nacion
...
class Ej3Test(unittest.TestCase):
    ...
    def test_unSoloAño(self): 
        res = frecuencia_posicion_por_nacion(
            ["arg", "aus", "nz", "sud"], 
            {2023:["nz", "sud", "arg", "aus"]})
    ...
    def test_renuncio_michael_cheika(self):
        ...
        res = frecuencia_posicion_por_nacion(naciones,torneos)
    ...
    def test_en_res_solo_hay_naciones_validas(self):
        ...
        torneos = {2023:["aus", "arg", "nz", "sud"],
             2021:["nz", "aus", "arg", "sud"],
             2019:["arg", "sud", "nz", "aus"]}
        resultado = frecuencia_posicion_por_nacion(naciones, torneos)
