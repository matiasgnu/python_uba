import unittest
import inspect
from solucion import pos_clientes
...
class Ej1Test(unittest.TestCase):
    ...
    def test_todosNegativosUmbral0(self):  
        res = pos_clientes([-1, -2, -3, -4, -8, -2], 10)
        self.assertEqual(res, -1)
