...
class Ej2Test(unittest.TestCase):
    ...
    def test_listasIgualCantidad(self): # Testea una lista con la misma cantidad de boletas por lista
        res = ordenar(['LLA', 'UP', 'LLA', 'UP', 'LLA', 'UP', 'LLA', 'UP', 'LLA', 'UP'])
        self.assertEqual(res, ['LLA', 'LLA', 'LLA', 'LLA', 'LLA', 'UP', 'UP', 'UP', 'UP', 'UP'])

    def test_masUPQueLLA(self): # Testea una lista con más de UP que de LLA
        res = ordenar(['UP', 'LLA', 'UP', 'LLA', 'UP', 'LLA', 'UP', 'LLA', 'UP'])
        self.assertEqual(res, ['LLA', 'LLA', 'LLA', 'LLA', 'UP', 'UP', 'UP', 'UP', 'UP'])

    def test_masLLAQueUP(self): # Testea una lista con más de LLA que de UP
        res = ordenar(['LLA', 'LLA', 'UP', 'LLA', 'UP', 'LLA', 'UP', 'LLA', 'UP'])
        self.assertEqual(res, ['LLA', 'LLA', 'LLA', 'LLA', 'LLA', 'UP', 'UP', 'UP', 'UP'])

    def test_soloUP(self): # Testea una lista con solo boletas de UP
        res = ordenar(['UP', 'UP', 'UP', 'UP', 'UP'])
        self.assertEqual(res, ['UP', 'UP', 'UP', 'UP', 'UP'])

    def test_soloUnaDeUP(self): # Testea una lista con solo una boleta de UP
        res = ordenar(['UP'])
        self.assertEqual(res, ['UP'])

    def test_soloLLA(self): # Testea una lista con solo boletas de LLA
        res = ordenar(['LLA', 'LLA', 'LLA', 'LLA', 'LLA'])
        self.assertEqual(res, ['LLA', 'LLA', 'LLA', 'LLA', 'LLA'])

    def test_soloUnaDeLLA(self): # Testea una lista con solo una boletas de LLA
        res = ordenar(['LLA'])
        self.assertEqual(res, ['LLA'])

    def test_estaOrdenada(self): # Testea una lista ya ordenada
        res = ordenar(['LLA', 'LLA', 'LLA', 'LLA', 'LLA', 'UP', 'UP', 'UP', 'UP', 'UP'])
        self.assertEqual(res, ['LLA', 'LLA', 'LLA', 'LLA', 'LLA', 'UP', 'UP', 'UP', 'UP', 'UP'])

    def test_estaOrdenadaAlReves(self): # Testea una lista que tiene primero todas boletas de UP y dsp todas de LLA
        res = ordenar(['UP', 'UP', 'UP', 'UP', 'UP', 'LLA', 'LLA', 'LLA', 'LLA', 'LLA'])
        self.assertEqual(res, ['LLA', 'LLA', 'LLA', 'LLA', 'LLA', 'UP', 'UP', 'UP', 'UP', 'UP'])

    def test_estaOrdenadaSalvoLaPrimera(self): # Testea una lista que tiene todo ordenado salvo la primer boleta
        res = ordenar(['LLA', 'LLA', 'LLA', 'LLA', 'UP', 'UP', 'UP', 'LLA', 'UP', 'UP'])
        self.assertEqual(res, ['LLA', 'LLA', 'LLA', 'LLA', 'LLA', 'UP', 'UP', 'UP', 'UP', 'UP'])

    def test_estaOrdenadaSalvoLaUltima(self): # Testea una lista que tiene todo ordenado salvo la ultima boleta
        res = ordenar(['UP', 'LLA', 'LLA', 'LLA', 'LLA', 'LLA', 'UP', 'UP', 'UP', 'UP'])
        self.assertEqual(res, ['LLA', 'LLA', 'LLA', 'LLA', 'LLA', 'UP', 'UP', 'UP', 'UP', 'UP'])

    def test_random1(self): # Testea una lista random
        res = ordenar(['LLA', 'LLA', 'UP', 'UP', 'UP', 'LLA', 'UP', 'LLA', 'LLA', 'UP'])
        self.assertEqual(res, ['LLA', 'LLA', 'LLA', 'LLA', 'LLA', 'UP', 'UP', 'UP', 'UP', 'UP'])

    def test_random2(self): # Testea una lista random
        res = ordenar(['UP', 'LLA', 'LLA', 'LLA', 'LLA','UP', 'UP', 'LLA', 'UP', 'UP'])
        self.assertEqual(res, ['LLA', 'LLA', 'LLA', 'LLA', 'LLA', 'UP', 'UP', 'UP', 'UP', 'UP'])

    def test_random3(self): # Testea una lista random
        res = ordenar(['UP', 'UP', 'LLA', 'UP', 'LLA', 'LLA', 'UP', 'LLA', 'UP', 'LLA'])
        self.assertEqual(res, ['LLA', 'LLA', 'LLA', 'LLA', 'LLA', 'UP', 'UP', 'UP', 'UP', 'UP'])

    def test_random4(self): # Testea una lista random
        res = ordenar(['LLA', 'LLA', 'UP', 'LLA', 'UP', 'LLA', 'LLA', 'UP', 'UP', 'UP',])
        self.assertEqual(res, ['LLA', 'LLA', 'LLA', 'LLA', 'LLA', 'UP', 'UP', 'UP', 'UP', 'UP'])
